    ...
    <div class="w-full max-w-2xl glass-effect rounded-2xl p-8 shadow-2xl slide-up relative z-10">
        <div class="mb-8 flex items-center justify-between">
            <div>
                ...
                <div class="text-white/80 mt-1">Landlord Account Setup</div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="file" name="national_id_image" id="national_id_image" accept="image/*" required
                    ...
                    <p class="text-xs text-white/70 mt-1">Upload a clear photo of your National ID for verification. This is required to list properties.</p>
                </div>
            </div>
    ...
    <script>
        ...
        completeBtn.addEventListener('click', async ()=>{
            ...
            try{
                ...
                const res = await fetch("{{ route('signup.oauth.complete.landlord') }}", {
                    method: 'POST',
                    body: fd
                });
